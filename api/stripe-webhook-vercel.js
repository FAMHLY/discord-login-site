...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Vercel parses the body automatically, but we need the raw buffer for Stripe
    const rawBody = req.body;
    
    // If the body is already parsed as JSON, we need to reconstruct it
    ...
    if (Buffer.isBuffer(rawBody)) {
      ...
      // Body was parsed as JSON object - reconstruct the raw JSON string
